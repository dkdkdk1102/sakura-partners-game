...
const UpdateNotice = {
  version: '2026-06-11-midboss',
  title: '大型アップデート',
  date: '2026/06/11',
  lead: '伊豆の旅と空のパトロールが、さらににぎやかに！',
  sections: [
    { title: '新しく遊べること', items: ['下田・ペリーロードの新ステージ', '伊東のさかなつり＋魚図鑑', 'うさメカを全9ステージ化'] },
    { title: '見た目・演出', items: ['中ボス3体を専用絵に差し替え', '冒険ボス5体を専用イラスト化', 'サクラパートナーズのゴール演出'] },
    { title: '音・遊びやすさ', items: ['シューティングBGM 4曲を追加', 'クラゲ・アイテム素材を強化', 'スマホ・タブレット対応を整備'] },
  ],
  active: false,
  auto: false,
  close: null,
