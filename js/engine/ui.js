...
const UpdateNotice = {
  version: '2026-06-11-balance',
  title: 'アップデートのお知らせ',
  date: '2026/06/11',
  lead: 'うさメカ パトロールが、手ごわく もっと熱くなりました！',
  sections: [
    { title: 'うさメカ大幅強化', items: ['全9ステージ（1-1〜3-3）に拡大', '中ボス3体が専用絵で登場', 'ボスは体力で3段階に攻撃変化'] },
    { title: '歯ごたえアップ', items: ['敵弾のスピードを強化', 'ウニ機雷の爆発がランダムに', 'ボスの体力を大幅増量'] },
    { title: 'そのほか', items: ['難易度3種＋専用ランキング', 'BGM4曲・新しい敵の動き', '冒険ゲームのボスも専用イラスト化'] },
  ],
  active: false,
  auto: false,
  close: null,
